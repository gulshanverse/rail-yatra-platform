...
class LLMSettings(BaseSettings):
    ...
    DEFAULT_PROVIDER: str = Field(
        default="mock", description="Default LLM provider to resolve."
    )
    DEFAULT_MODEL: str = Field(
        default="mock-model", description="Default model name to resolve."
    )
    ...
    ENABLE_MOCK_LLM: bool = Field(
        default=True,
        description="Enables Mock Chat client globally for tests/offline runs.",
    )
