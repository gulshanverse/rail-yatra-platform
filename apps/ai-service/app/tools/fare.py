...
def calculate_fare(train_number: str, booking_class: str, distance_km: int = 500, is_tatkal: bool = False) -> Dict[str, Any]:
    """
    Computes ticket fares including base fares, dynamic pricing surcharges, Tatkal fees, and GST.
    """
    logger.info(f"Calculating fare for train: {train_number}, class: {booking_class}, Tatkal: {is_tatkal}")
    ...
    dynamic_surcharge = int(base_fare * 0.15) if booking_class.upper() in ["3A", "2A", "1A"] else 0
