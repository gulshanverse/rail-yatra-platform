...
STATION_WEATHER_DATA = {
    "NDLS": {"city": "New Delhi", "temp": "34°C", "condition": "Partly Cloudy", "delay_impact": "None"},
    "BPL": {"city": "Bhopal", "temp": "29°C", "condition": "Heavy Rain", "delay_impact": "Low (Avg 15 min delays)"},
    "MAS": {"city": "Chennai", "temp": "31°C", "condition": "Humid / Sunny", "delay_impact": "None"},
    "HWH": {"city": "Kolkata", "temp": "30°C", "condition": "Thunderstorms", "delay_impact": "Medium (Avg 30 min delays)"},
    "CSMT": {"city": "Mumbai", "temp": "28°C", "condition": "Monsoon Showers", "delay_impact": "Medium (Avg 20-40 min delays)"}
}
