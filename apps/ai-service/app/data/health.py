...
class ProviderHealthMonitor:
    ...
    def __init__(self):
        ...
        self._registry: Dict[str, Dict[str, Any]] = {
            "synthetic": {"status": "healthy", "consecutive_failures": 0, "last_checked": time.time()},
            "irctc": {"status": "healthy", "consecutive_failures": 0, "last_checked": time.time()},
            "ntes": {"status": "healthy", "consecutive_failures": 0, "last_checked": time.time()}
        }
    ...
    def record_failure(self, provider_name: str, threshold: int = 3) -> None:
        ...
        if p_name in self._registry:
            ...
            if failures >= threshold:
                ...
                logger.warning(f"Provider '{p_name}' has been marked OFFLINE due to {failures} consecutive failures.")
