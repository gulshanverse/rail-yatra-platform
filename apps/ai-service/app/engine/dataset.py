...
ADJACENT_STATIONS_MAP = {
    "BPL": [
        {"code": "RKMP", "name": "Rani Kamalapati (Habibganj)", "distance_km": 6, "transfer_time_mins": 15},
        {"code": "ET", "name": "Itarsi Junction", "distance_km": 90, "transfer_time_mins": 90} # major junction alternative
    ],
    "NDLS": [
        {"code": "NZM", "name": "Hazrat Nizamuddin", "distance_km": 7, "transfer_time_mins": 25},
        {"code": "ANVT", "name": "Anand Vihar Terminal", "distance_km": 12, "transfer_time_mins": 35},
        {"code": "DLI", "name": "Old Delhi Junction", "distance_km": 4, "transfer_time_mins": 20}
    ],
    "MAS": [
        {"code": "MS", "name": "Chennai Egmore", "distance_km": 3, "transfer_time_mins": 15},
...
def get_train_delay_metrics(train_number: str) -> Dict[str, Any]:
    ...
    return HISTORICAL_TRAIN_DELAYS.get(train_number, {
        "avg_delay_mins": 25,
        "punctuality_rating": "B-",
